...
<body>
  <div class="container-fluid">
    ...
    <div class="module">
      <h2 class="module-title">Rapports du jour du projet</h2>
    ...
    <div class="module">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          @else
          <p>Aucun besoin n'a été fait aujourd'hui.</p>
          @endif
        </div>
      </div>
    </div>
    ...
    <h1 class="module-title">Les activités du projet</h1>
    <!-- Autre module projetEnAttenteAjourdhui -->
    <div class="module">
      <div class="row">
        <div class="col-md-6">
          <h2 class="module-title">Activité en cours</h2>
          <!-- Tableau pour afficher les détails des projets en cours -->
    ...
    <div class="module">
      <div class="row">
        <div class="col-md-6">
          <h2 class="module-title">Activité en attente</h2>
          <!-- Tableau pour afficher les détails des projets en cours -->
