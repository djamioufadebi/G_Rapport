...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/mon_style.css') }}">
</head>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/home') }}">
                    <img src="images/innov2b.jpg" class="img-fluid" width="100" height="auto" alt=""
                        srcset="">
                </a>
                <a class="navbar-brand" href="{{ url('/home') }}">
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="{{ route('password.change') }}">Changer mot de
                                            passe</a>
