        ...
        <div class="card-body container ">
           ...
           @enderror"
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                        class="form-control  @error('date_participation')is-invalid
           @enderror"
                        name="date_participation" wire:model="date_participation" required>
                ...
                <div class=" d-flex justify-content-between mb-3">
                    <a href="{{ route('intervenants') }}" class="btn btn-sm btn-danger text-white fs-6">Retourner à la
                        liste</a>
