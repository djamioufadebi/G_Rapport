          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="mb-3">
                ...
                <div class="error-message invalid-feedback" style="display: none;">Le champ de date début est requis.
                </div>
              </div>
...
<script src="{{asset('js\js_activite\statut_change_activite.js')}}"></script>